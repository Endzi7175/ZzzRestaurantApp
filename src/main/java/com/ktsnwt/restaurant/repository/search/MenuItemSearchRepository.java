 ...
 */
public interface MenuItemSearchRepository extends ElasticsearchRepository<MenuItem, Long>, MenuItemSearchRepositoryInternal {}

interface MenuItemSearchRepositoryInternal {
    Page<MenuItem> search(String query, Pageable pageable);
}
...
class MenuItemSearchRepositoryInternalImpl implements MenuItemSearchRepositoryInternal {
    ...
    MenuItemSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
    ...
    public Page<MenuItem> search(String query, Pageable pageable) {
        ...
        List<MenuItem> hits = elasticsearchTemplate
            .search(nativeSearchQuery, MenuItem.class)
