...
/**
 * REST controller for managing {@link com.ktsnwt.restaurant.domain.MenuItem}.
 */
@RestController
@RequestMapping("/api")
public class MenuItemResource {
    ...
    public ResponseEntity<List<MenuItemDTO>> getAllMenuItems(
        ...
        Page<MenuItemDTO> page;
        if (eagerload) {
            page = menuItemService.findAllWithEagerRelationships(pageable);
        } else {
            page = menuItemService.findAll(pageable);
        }
    ...
    /**
     * {@code SEARCH  /_search/menu-items?query=:query} : search for the menuItem corresponding
     * to the query.
     *
