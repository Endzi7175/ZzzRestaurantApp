...
describe('Alert service test', () => {
  describe('Alert Service Test', () => {
    ...
    it('should produce an alert object with correct id', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Hello User info' });
      expect(service.addAlert({ type: 'success', message: 'Hello User success' })).toEqual(
        expect.objectContaining({
          type: 'success',
    ...
    it('should close an alert correctly', inject([AlertService], (service: AlertService) => {
      const alert0 = service.addAlert({ type: 'info', message: 'Hello User info' });
      const alert1 = service.addAlert({ type: 'info', message: 'Hello User info 2' });
      const alert2 = service.addAlert({ type: 'success', message: 'Hello User success' });
    ...
    it('should clear alerts', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Hello User info' });
      service.addAlert({ type: 'danger', message: 'Hello User info' });
      service.addAlert({ type: 'success', message: 'Hello User info' });
      expect(service.get().length).toBe(3);
      service.clear();
      expect(service.get().length).toBe(0);
    }));
    ...
    it('should produce a success message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'success', message: 'Hello User' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello User',
        } as Alert)
    ...
    it('should produce a success message with custom position', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'success', message: 'Hello User', position: 'bottom left' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello User',
    ...
    it('should produce a error message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'danger', message: 'Hello User' })).toEqual(
        expect.objectContaining({
          type: 'danger',
          message: 'Hello User',
        } as Alert)
    ...
    it('should produce a warning message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'warning', message: 'Hello User' })).toEqual(
        expect.objectContaining({
          type: 'warning',
          message: 'Hello User',
        } as Alert)
    ...
    it('should produce a info message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'info', message: 'Hello User' })).toEqual(
        expect.objectContaining({
          type: 'info',
          message: 'Hello User',
        } as Alert)
    ...
    it('should produce a info message with translated message if key exists', inject(
      ...
      (service: AlertService, translateService: TranslateService) => {
        translateService.setTranslation('en', {
          'hello.application': 'Translated message',
        });
        expect(service.addAlert({ type: 'info', message: 'Hello User', translationKey: 'hello.application' })).toEqual(
          expect.objectContaining({
            type: 'info',
    ...
    it('should produce a info message with provided key if transltion key does not exist in translations and message is not provided', inject(
      [AlertService, TranslateService],
      (service: AlertService) => {
        expect(service.addAlert({ type: 'info', translationKey: 'hello.application' })).toEqual(
          expect.objectContaining({
            type: 'info',
