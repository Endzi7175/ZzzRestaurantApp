...
export class MenuItemComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.menuItemService
        ...
        .subscribe({
          next: (res: HttpResponse<IMenuItem[]>) => {
  ...
  search(query: string): void {
    if (query && ['name', 'description', 'type'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IMenuItem[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
