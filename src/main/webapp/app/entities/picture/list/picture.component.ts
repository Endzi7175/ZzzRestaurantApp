...
export class PictureComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.pictureService
        ...
        .subscribe({
          next: (res: HttpResponse<IPicture[]>) => {
  ...
  search(query: string): void {
    if (query && ['name', 'pictureUrl'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IPicture[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
