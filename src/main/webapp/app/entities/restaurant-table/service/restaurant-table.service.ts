...
export class RestaurantTableService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/restaurant-tables');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IRestaurantTable[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
