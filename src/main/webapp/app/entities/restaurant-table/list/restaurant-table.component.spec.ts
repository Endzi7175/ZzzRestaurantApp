...
describe('RestaurantTable Management Component', () => {
  let comp: RestaurantTableComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'restaurant-table', component: RestaurantTableComponent }]),
      ...
      .overrideTemplate(RestaurantTableComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.restaurantTables?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
