...
import com.ktsnwt.restaurant.domain.Authority;
import com.ktsnwt.restaurant.domain.User;
import com.ktsnwt.restaurant.repository.UserRepository;
import com.ktsnwt.restaurant.repository.search.UserSearchRepository;
import com.ktsnwt.restaurant.security.AuthoritiesConstants;
import com.ktsnwt.restaurant.service.dto.AdminUserDTO;
import com.ktsnwt.restaurant.service.dto.UserDTO;
import com.ktsnwt.restaurant.service.mapper.UserMapper;
import com.ktsnwt.restaurant.web.rest.vm.ManagedUserVM;
...
class UserResourceIT {
    ...
    private static final String UPDATED_LOGIN = "user";

    private static final Long DEFAULT_ID = 1L;

    private static final String DEFAULT_PASSWORD = "passjohndoe";
    private static final String UPDATED_PASSWORD = "passuser";

    private static final String DEFAULT_EMAIL = "johndoe@localhost";
    private static final String UPDATED_EMAIL = "user@localhost";

    private static final String DEFAULT_FIRSTNAME = "john";
    private static final String UPDATED_FIRSTNAME = "userFirstName";

    private static final String DEFAULT_LASTNAME = "doe";
    private static final String UPDATED_LASTNAME = "userLastName";
     ...
     *
     * @see com.ktsnwt.restaurant.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        managedUserVM.setEmail("user@localhost"); // this email should already be used by anotherUser
        managedUserVM.setActivated(updatedUser.isActivated());
    ...
    void updateUserExistingLogin() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setId(updatedUser.getId());
        managedUserVM.setLogin("user"); // this login should already be used by anotherUser
        managedUserVM.setPassword(updatedUser.getPassword());
        managedUserVM.setFirstName(updatedUser.getFirstName());
        managedUserVM.setLastName(updatedUser.getLastName());
