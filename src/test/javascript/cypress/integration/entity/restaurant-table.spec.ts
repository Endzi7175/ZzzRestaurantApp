...
describe('RestaurantTable e2e test', () => {
  ...
  describe('new RestaurantTable page', () => {
    ...
    it('should create an instance of RestaurantTable', () => {
      cy.get(`[data-cy="tableNo"]`).type('31345').should('have.value', '31345');

      cy.get(`[data-cy="seatsNo"]`).type('5375').should('have.value', '5375');

      cy.get(`[data-cy="description"]`).type('Borders Steel').should('have.value', 'Borders Steel');

      cy.get(`[data-cy="xPositionFrom"]`).type('66183').should('have.value', '66183');

      cy.get(`[data-cy="xPositionTo"]`).type('1035').should('have.value', '1035');

      cy.get(`[data-cy="yPositionFrom"]`).type('51696').should('have.value', '51696');

      cy.get(`[data-cy="yPositionTo"]`).type('15289').should('have.value', '15289');
